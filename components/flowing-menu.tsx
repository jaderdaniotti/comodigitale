...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  }, [text, image, emoji, repetitions, speed]);
  ...
  return (
    <div
      className="relative flex-none overflow-hidden text-center"
      ref={itemRef}
      ...
      >
        <div className="flex h-full w-fit" ref={marqueeInnerRef}>
          {[...Array(repetitions)].map((_, idx) => (
            ...
            >
              <span className="font-display flex items-center gap-3 px-[1vw] text-[clamp(1.05rem,2.6vw,1.65rem)] leading-none font-semibold whitespace-nowrap uppercase">
                {renderEmoji()}
                {text}
              </span>
            </div>
